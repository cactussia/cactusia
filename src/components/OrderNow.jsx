...
function OrderNow() {
  ...
  return (
    <div className="flex-1 flex justify-center items-center  h-full">
      <div className="md:w-64 px-4 mb-5">
        ...
        <button className="rounded-lg w-full md:w-fit hover:bg-green-dark duration-200 hover:scale-105 px-6 py-3 bg-green flex justify-center items-center gap-2 text-white font-normal text-lg">
          Order now
          <EastRoundedIcon/>
        </button>
      </div>
