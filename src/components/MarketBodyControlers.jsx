...
function MarketBodyControlers() {
  ...
  return (
    <motion.div
      initial={{ x: -200 }}
      animate={{ x: 0 }}
      className=" flex-1 flex flex-col md:gap-2 justify-center items-center lg:items-center px-3 md:px-0"
    >
      <div className="flex flex-row lg:flex-col gap-2 justify-around w-full md:w-fit mt-5 lg:mt-0">
        <div className=" flex flex-col justify-center items-start  ">
          <div className=" w-fit p-1 rounded-lg border-2 border-[#0001]  relative drop-shadow-md flex bg-dark-white gap-2 mt-4">
            <button
              className="rounded-md p-2 md:p-4 hover:bg-[#0001]"
              onClick={handleCactusSwapLeft}
            >
            ...
            <button
              className="rounded-md  p-2 md:p-4 hover:bg-[#0001]"
              onClick={handleCactusSwapRight}
            >
              <KeyboardArrowRightIcon className="text-green scale-150" />
            </button>
            <div className="absolute -bottom-3 left-[50%] translate-x-[-50%] px-2 bg-dark-white border rounded-md drop-shadow-md">
              {cactus + 1} / {finalCactus?.length}
            </div>
          </div>
          <div className="  text-dark-green w-fit md:w-full pt-3">
            {finalCactus[cactus]?.name}
          </div>
        </div>
        ...
        <div className=" flex flex-col justify-center items-start  ">
          <div className=" w-fit p-1 rounded-lg border-2 border-[#0001]  relative drop-shadow-md flex bg-dark-white gap-2 mt-4">
            ...
            <button
              className="rounded-md  p-2 md:p-4 hover:bg-[#0001]"
              onClick={handlePotSwapRight}
            >
              <KeyboardArrowRightIcon className="text-green scale-150" />
            </button>
            <div className="absolute -bottom-3 left-[50%] translate-x-[-50%] px-2 bg-dark-white border rounded-md drop-shadow-md">
              {pot + 1} / {finalPots?.length}
            </div>
          </div>
          <div className="  text-dark-green w-fit md:w-full pt-3">
            {finalPots[pot]?.name}
      ...
      {/* <div className="flex flex-col ">
        <div className=" w-fit p-1 rounded-lg drop-shadow-md border-2 border-[#0001] flex bg-dark-white gap-2 mt-4">
          ...
          <button
            className="p-2 md:p-4 rounded-md hover:bg-[#0001]"
