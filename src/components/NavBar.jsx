  ...
  return (
    <div className='container h-32 p-4 md:px-8  md:py-8 mx-auto flex justify-between items-start '>
        ...
        <div className='flex-1 flex justify-end'>
            <button onClick={()=>setOpen(p=>!p)} className={(open?" bg-dark-white ":" bg-green ")+' w-12 h-12 md:w-16 md:h-16 hover:text-white rounded-full z-50 duration-200  hover:scale-105'}>
              {
                  open?
